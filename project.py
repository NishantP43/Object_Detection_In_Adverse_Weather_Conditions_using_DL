...
labels = open(r'C:\Semester Wise\SEM - 3\Mini - Project 1\Codes\Object-Detection-In-Adverse-Weather-Conditions-using-deep-learning\coco.names').read().strip().split('\n')
weights_path = r'C:\Semester Wise\SEM - 3\Mini - Project 1\Codes\Object-Detection-In-Adverse-Weather-Conditions-using-deep-learning\Major project\Major_project_code\yolo-coco-data\yolov4.weights'
configuration_path = r'C:\Semester Wise\SEM - 3\Mini - Project 1\Codes\Object-Detection-In-Adverse-Weather-Conditions-using-deep-learning\Codes\Major project\Major_project_code\yolo-coco-data\yolov4.cfg'
...
image_path = r'C:\Semester Wise\SEM - 3\Sample images\foggy_sample1.jpg'
